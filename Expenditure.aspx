<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="Expenditure.aspx.cs" Inherits="Expenditure" enableEventValidation="true" %>
       ...
       <div id="content-main-div">
          ...
          <div id="right-pane-div">
	            ...
	            <div id="grid-div">
                    ...
                    <h1 class="auto-style1">&nbsp;myPurse Expenditure </h1>
                    <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="True" ShowSummary="False" />
                    <p>
                    &nbsp;<asp:Panel ID="myPanel" runat="server" BorderColor="#006699" BorderStyle="Solid" BorderWidth="1px" Height="197px">
                        ...
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td class="auto-style23" style="text-align: right">Expenditure Description</td>
                                <td class="auto-style21">
